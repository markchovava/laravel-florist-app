            ...
            <div class="my-md-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                        ...
                        <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">{{ $category_name->name }}</li>
                    </ol>
                </nav>
            </div>
            <!-- End breadcrumb -->
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 col-wd-9gdot5">
                ...
                <div class="flex-center-between mb-3">
                    <h3 class="font-size-25 mb-0">{{ $category_name->name }}</h3>
