...
<main id="content" role="main" class="checkout-page">
    ...
    <div class="container">
        ...
        <form action="{{ route('customer.quote.checkout.process') }}" method="post">
            @csrf
            <div class="row">
                    ...
                    <div class="pl-lg-3 ">
                        <div class="bg-gray-1 rounded-lg">
                            ...
                            <div class="p-4 mb-4 checkout-table">                              
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                $zwl_subtotal = $quote->quote_subtotal * $zwl_currency->value;
                                                @endphp
                                                ${{ number_format((float)$subtotal, 2, '.', '') }}
                                                <input type="hidden" name="quote_subtotal" value="{{ $quote->quote_subtotal }}">
                                                <input type="hidden" name="quote_zwl_subtotal" value="{{ $zwl_subtotal }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Shipping</th>
                                            <td>
                                                @php
                                                $shipping_feeCents = $quote->shipping_fee;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                $quote_totalCents = $quote->grandtotal;
                                                $quote_total = $quote_totalCents / 100;
                                                @endphp
                                                <strong>${{ number_format((float)$quote_total, 2, '.', '') }}</strong>
                                                <input type="hidden" name="quote_total" value="{{ $quote_totalCents }}">
                                                <input type="hidden" name="total_payamount" value="{{ number_format((float)$quote_total, 2, '.', '') }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Total (ZWL)</th>
                                            <td>
                                                @php
                                                $quote_zwltotalCents = $quote->zwl_grandtotal;
                                                $quote_zwltotal = $quote_zwltotalCents / 100;
                                                @endphp
                                                <strong>${{ number_format((float)$quote_zwltotal, 2, '.', '') }}</strong>
                                                <input type="hidden" name="quote_zwltotal" value="{{ $quote_zwltotalCents }}">
                                                <input type="hidden" name="total_payzwlamount" value="{{ number_format((float)$quote_zwltotal, 2, '.', '') }}">
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <button type="submit" class="btn btn-primary-dark-w btn-block btn-pill font-size-20 mb-3 py-3">Generate PDF Quote</button>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" name="first_name" value="" required="required" placeholder="Your First name." class="form-control"  aria-label="Jack" autocomplete="off">
                                </div>
                                <!-- End Input -->
                            </div>
