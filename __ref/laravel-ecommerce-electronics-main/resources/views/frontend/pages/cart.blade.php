                    ...
                    <tbody>
                        ...
                        <tr class="product__item" id="{{ $product->id }}">
                            <td class="text-center">
                                <a href="{{ route('cart.delete', $product->id) }}" id="remove__btnInCart" class="text-gray-32 font-size-26">×</a>
                            </td>
                                        ...
                                        <div class="mb-3 mb-md-0 w-xl-40">
                                            ...
                                            <form class="js-focus-state">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="text" id="subscribeSrEmailExample1" placeholder="Coupon code" aria-label="Coupon code" aria-describedby="subscribeButtonExample2">
                            ...
                            <tbody>
                                <tr class="cart-subtotal">
                                    ...
                                    <td data-title="Subtotal">
                                        ...
                                        <input type="hidden" name="cart_subtotalCents" value="0" class="cart__subtotalCents">
                                    </td>
                                </tr>
                                <tr class="shipping">
...
<script>
    ...
    let cart_subtotalCentsInsert = $('.cart__subtotalCents');
    let cart_subtotalInsert = $('.cart__subtotal'); 
    ...
    */
    ...
    $(document).on('click', '.quantity-minus, .quantity-add', function(e){  
        ...
        /* Calculate Cart Total */
        let cart_subtotalCentsInsert = $('.cart__subtotalCents');
        let cart_subtotal = $('.cart__subtotal');
        let products_totalInCents = new Array();
        $('.product__totalCents').each((i, item) => {
            products_totalInCents.push(item.value);
        }); 
     ...
     $(document).on('click', '#remove__btnInCart', function(e){  
        ...
        let product_item = $(this).attr('href');
        $.ajaxSetup({
            headers: {
