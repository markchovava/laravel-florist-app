                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="{{ (!empty($user->image)) ? url('storage/users/images/' . $user->image) : url('storage/users/no_image.jpg') }}" 
                                alt="{{ $user->name }}" 
                                ...
                                <div class="d-flex flex-column flex-grow-1 pe-8">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            ...
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-bold fs-6 text-gray-400">Role</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                                    </div>
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <span class="fw-bold text-gray-800 fs-6">{{ $user->phone_number }}</span>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-7">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <span class="fw-bold text-gray-800 fs-6">{{ $user->id_number }}</span>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
