    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Tags</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <form action="{{ route('admin.tag.search') }}" method="GET">
                                ...
                                class="form-control form-control-solid w-250px ps-14" placeholder="Search Tag" />
                            </form>
                        </div>
                        <!--end::Search-->
                    </div>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            @if( isset($tags) )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="" class="symbol symbol-50px">
                                                ...
                                                style="background-image:url({{ (!empty($tag->image)) ? url('storage/tags/' . $tag->image) : url('storage/tags/no_image.jpg') }});"></span>
                                            </a>
                                            <!--end::Thumbnail-->
                                            <div class="ms-5">
                                                <!--begin::Title-->
                                                ...
                                                <div class="text-muted fs-7 fw-bolder">
                                                    Position: <span class="badge badge-light-success">{{ $tag->position}}</span>
                                                </div>
                                                <!--end::Description-->
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <!--begin::Badges-->
                                        <div class="badge badge-light-info">{{ $tag->status }}</div>
                                        <!--end::Badges-->
                                    </td>
                                    <!--end::Type=-->
                                    <!--begin::Action=-->
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('admin.tag.edit', $tag->id) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
