                        ...
                        <div class="h-100 card card-flush py-4">
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="image__upload mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="file" name="ad_image" value="{{ $ad->image }}" class="form-control mb-2 ad__upload" placeholder="Category Name" value="" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    ...
                                    <section class="display__area" style="margin-top:1rem;">
                                        <div class="upload__placeholder text-muted display__none">Upload image will appear here.</div>
                                        <img class="image__cover"
                                        src="{{ (!empty($ad->image)) ? url('storage/images/ad/' . $ad->image) : '' }}" alt="">
                                ...
                                <div class="mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <input type="text" name="ad_title" value="{{ $ad->title }}" class="form-control mb-2" placeholder="Add Description..." value="" />
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <input type="text" name="ad_description" value="{{ $ad->description }}" class="form-control mb-2" placeholder="Add Description..." value="" />
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Editor-->
                                            <input type="number" name="ad_price" value="{{ $ad->price }}" class="form-control mb-2" placeholder="Add price in cents..." />
                                            <!--end::Editor-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Editor-->
                                            <input type="number" name="ad_percent" value="{{ $ad->percent }}" class="form-control mb-2" placeholder="Add Percentage..." />
                                            <!--end::Editor-->
                                            <!--begin::Description-->
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="mb-10">
                                    ...
                                    <select name="ad_position" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add__status_select">
                                        ...
                                        <option value="First" {{ ($ad->position == 'First') ? 'selected="selected"' : '' }}>First</option>
                                        <option value="Second" {{ ($ad->position == 'Second') ? 'selected="selected"' : '' }}>Second</option>
                                        <option value="Third" {{ ($ad->position == 'Third') ? 'selected="selected"' : '' }}>Third</option>
                                        <option value="Forth" {{ ($ad->position == 'Forth') ? 'selected="selected"' : '' }}>Forth</option>
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <input type="text" name="ad_click_name" value="{{ $ad->click_name }}" class="form-control mb-2" placeholder="Add Button Name..."/>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <input type="text" name="ad_link" value="{{ $ad->link }}"  class="form-control mb-2" placeholder="Add Price..." />
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <select name="ad_status" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
                                        <option></option>
                                        <option value="Published" {{ ($ad->status == 'Published') ? 'selected="selected"' : '' }} >Published</option>
                                        <option value="Scheduled" {{ ($ad->status == 'Scheduled') ? 'selected="selected"' : '' }} >Scheduled</option>
                                        <option value="Unpublished" {{ ($ad->status == 'Unpublished') ? 'selected="selected"' : '' }} >Unpublished</option>
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                ...
                                <!--end::Input group-->
                                    ...
                                    <select name="ad_page" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
                                        <option></option>
                                        <option value="Home" {{ ($ad->page == 'Home') ? 'selected="selected"' : '' }}>Home</option>
                                        <option value="Other" {{ ($ad->page == 'Other') ? 'selected="selected"' : '' }}>Other</option>
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Set the ad status.</div>
