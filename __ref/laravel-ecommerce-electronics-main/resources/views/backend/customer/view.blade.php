                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-center flex-column mb-5">
                                ...
                                <div class="symbol symbol-150px symbol-circle mb-7">
                                    <img src="{{ (!empty($customer->image)) ? url('storage/users/images/' . $customer->image) : url('storage/users/no_image.jpg') }}" alt="image" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                ...
                                <!--end::Name-->
                                <!--begin::Email-->
                                <a href="#" class="fs-5 fw-bold text-muted text-hover-primary mb-6">
                                    {{ $customer->email }}
                                </a>
                                <!--end::Email-->
                            </div>
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                ...
                                <!--begin::Badge-->
                                <div class="badge badge-light-info d-inline">{{ $customer->role->name }}</div>
                                <!--begin::Badge-->
                            </div>
                            <!--end::Details toggle-->
                            ...
                            <div class="pb-5 fs-6">
                                ...
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bolder mt-5">Physical Address</div>
                                <div class="text-gray-600" style="width:90%;">
                                ...
                                <div class="card-body pt-0 pb-5">
                                    ...
                                    <form class="form" action="#" id="kt_ecommerce_customer_profile">
                                        ...
                                        <div class="mb-7">
                                            ...
                                            <div class="mt-1">
                                                ...
                                                style="background-image:url({{ asset('backend/assets/media/svg/avatars/blank.svg') }});">
                                                    ...
                                                    style="background-image:url({{ (!empty($customer->image)) ? url('storage/users/images/' . $customer->image) : url('storage/users/no_image.jpg') }})"></div>
                                        ...
                                        <div class="row row-cols-1 row-cols-md-2">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" class="form-control form-control-solid" placeholder="" name="customer_first_name" value="{{ $customer->first_name}}" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <label class="fs-6 fw-bold mb-2">
                                                        <span>Last Name</span>
                                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Last Name"></i>
                                                    </label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="customer_last_name" value="{{ $customer->last_name }}"  class="form-control form-control-solid" placeholder="Last Name" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="email" name="customer_email" value="{{ $customer->email }}"  placeholder="mark@abs.com"  class="form-control form-control-solid"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="customer_phone_number" value="{{ $customer->phone_number }}" class="form-control form-control-solid" placeholder="+263 (0) 782 210021" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="py-3 d-flex flex-stack flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center collapsible rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_1" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_1">
                                                ...
                                                <!--end::Arrow-->
                                                <!--begin::Logo-->
                                                <img src="{{ asset('backend/assets/media/svg/card-logos/mastercard.svg') }}" class="w-40px me-3" alt="" />
                                                <!--end::Logo-->
                                                <!--begin::Summary-->
                                                <div class="me-3">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-bold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">**** 5374</td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="py-3 d-flex flex-stack flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_2" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_2">
                                                ...
                                                <!--end::Arrow-->
                                                <!--begin::Logo-->
                                                <img src="{{ asset('backend/assets/media/svg/card-logos/visa.svg') }}" class="w-40px me-3" alt="" />
                                                <!--end::Logo-->
                                                <!--begin::Summary-->
                                                <div class="me-3">
                                                    <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-wrap py-5">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-bold gy-1">
                                                        ...
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                                            <td class="text-gray-800">**** 3334</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Expires</td>
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="py-3 d-flex flex-stack flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_3" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_3">
                                                ...
                                                <!--end::Arrow-->
                                                <!--begin::Logo-->
                                                <img src="{{ asset('backend/assets/media/svg/card-logos/american-express.svg') }}" class="w-40px me-3" alt="" />
                                                <!--end::Logo-->
                                                <!--begin::Summary-->
                                                <div class="me-3">
                                                    <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-wrap py-5">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-bold gy-1">
                                                        ...
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                                            <td class="text-gray-800">**** 3513</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Expires</td>
