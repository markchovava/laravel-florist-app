                ...
                <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-12">
                            <!--begin::Form-->
                            <form method="post" action="{{ route('admin.quote.update', $quote->id) }}">
                                @csrf
                                <!--begin::Wrapper-->
                                <div class="d-flex flex-column align-items-start flex-xxl-row">
                                    ...
                                    <div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify quotation date">
                                        ...
                                        <div class="position-relative d-flex align-items-center w-150px">
                                            <!--begin::Datepicker-->
                                            <input type="date" name="quote_date" value="{{ $quote->quote_date }}" class="form-control form-control-transparent fw-bolder pe-5" placeholder="Select date" />
                                            <!--end::Datepicker-->
                                            <!--begin::Icon-->
                                    ...
                                    <div class="d-flex align-items-center justify-content-end flex-equal order-3 fw-row" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify Quotation due date">
                                        ...
                                        <div class="position-relative d-flex align-items-center w-150px">
                                            <!--begin::Datepicker-->
                                            <input type="date" name="quote_due_date" value="{{ $quote->quote_due_date}}" class="form-control form-control-transparent fw-bolder pe-5" placeholder="Select date" />
                                            <!--end::Datepicker-->
                                            <!--begin::Icon-->
                                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
                                        ...
                                        <table class="table g-5 gs-0 mb-0 fw-bolder text-gray-700">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr class="align-top fw-bolder text-gray-700">
                                                    ...
                                                    <span><input name="grandtotal" value="{{ $quote->grandtotal_cents / 100 }}" type="text" class="grand__total form-controll"></span><br>
                                                    <input name="grandtotal_cents" type="hidden" value="{{ $quote->grandtotal_cents }}" class="grand__totalCents"></th>
                                                </tr>
                                            </tfoot>
                                            <!--end::Table foot-->
                                        </table>
