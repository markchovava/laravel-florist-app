            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-title">
                        <!--begin::Search-->
                        <form method="get" action="{{ route('admin.role.search') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif( $result->level_id == 3 )
                                            Editor
                                        @elseif( $result->level_id == 4 )
                                            Operator
                                        @elseif( $result->level_id == 5 )
                                            Delivery
                                        @else
                                            Not Defined
                                        @endif
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('admin.role.view', $result->id) }}" 
                                                    class="menu-link px-3">
                                                    View
                                                </a>
                                            </div>
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('admin.role.edit', $result->id) }}" 
                                                    class="menu-link px-3">
                                                    Edit
                                                </a>
                                            </div>
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('admin.role.delete', $result->id) }}" 
                                                    class="menu-link px-3">Delete</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
