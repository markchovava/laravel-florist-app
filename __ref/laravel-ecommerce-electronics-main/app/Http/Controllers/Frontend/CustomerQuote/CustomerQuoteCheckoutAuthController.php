...
class CustomerQuoteCheckoutAuthController extends Controller
{
    public function login(){
         ...
         if( Auth::check() ){
             ...
             if( isset($quote_session) || isset($ip_address) ){
                 ...
                 if( !empty($data['quote']) ){
                     ...
                     $data['customer_quote_items'] = CustomerQuoteItem::with('product')->where('customer_quote_id', $customer_quote_id)->get();
                    // dd($data['customer_quote_items']);
                    ...
                    */
                    ...
                    return view('frontend.pages.quote.login', $data);
     ...
     public function login_process(Request $request){
         ...
         if(Auth::attempt($credentials, $remember)){
             ...
             return redirect()->route('customer.quote.checkout')->with($notification);
         }else{
             $notification = [
                 'message' => 'Login failed...',
                 'alert-type' => 'danger'
             ];
             return redirect()->route('customer.quote.checkout.login')->with($notification);
         }
     }
            ...
            if( isset($quote_session) || isset($ip_address) ){
                ...
                if( !empty($data['quote']) ){
                   ...
                   */
                   ...
                   return view('frontend.pages.quote.register', $data);
